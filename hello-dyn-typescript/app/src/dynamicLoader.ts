import { Calculator } from '@hello-dyn/calculator-lib';
    ...
    async loadCalculator(calculatorType: string): Promise<boolean> {
        try {
            ...
            switch (calculatorType) {
                case 'basic':
                    const basicModule = await import('@hello-dyn/calculator-lib');
                    CalculatorClass = basicModule.BasicCalculator;
                    break;
                case 'advanced':
                    const advancedModule = await import('@hello-dyn/calculator-lib');
